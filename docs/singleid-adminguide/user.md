...
!!! info
    * ユーザのメールアドレス宛にクライアント証明書のダウンロードリンクを送信したくない場合には、**管理者ポータル画面＞管理＞詳細設定**画面の**通知方法＞証明書の通知方法**を**無効**にします。発行されたクライアント証明書は、**管理者ポータル画面＞認証＞証明書**画面の**証明書**タブからダウンロードすることができます。
