...
3. **サードパーティの SSO プロファイル**セクションの**SAML プロファイルを追加**をクリックします。
4. **IdP の詳細**ページの下部にある**以前の SSO プロファイル設定に移動**をクリックします。
5. **以前の SSO プロファイル**画面で、SSO設定を行います。

    [![Screenshot](/images/2023-07-16_11-14-16.png)](/images/2023-07-16_11-14-16.png)

6. 以下の内容で設定し、**保存**をクリックします。
