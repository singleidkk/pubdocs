...
2. 以下を設定し、**保存&適用**ボタンをクリックします。
    ...
    | **ネットマスク** | 機器本体のIPアドレスのネットマスクを設定します。 |
    | **デフォルトゲートウェイ** | 機器本体のデフォルトゲートウェイを設定します。 |

3. 機器本体のIPアドレスが変更されたのでGUIへ再ログインします。
4. **アライドテレシス 無線LANアクセスポイント GUI＞設定＞無線LAN＞無線1＞基本設定**タブへ移動します。
5. 以下を設定し、**保存&適用**ボタンをクリックします。

    | **設定項目** | **設定内容** |
    | :--- | :--- |
    | **ステータス** | **有効**を選択します。 |

6. **アライドテレシス 無線LANアクセスポイント GUI＞設定＞VAP/セキュリティー＞無線1＞VAP0/バーチャルアクセスポイント**タブへ移動します。
7. 以下を設定し、**一時保存**ボタンをクリックします。
...
8. **アライドテレシス 無線LANアクセスポイント GUI＞設定＞VAP/セキュリティー＞無線1＞VAP0/セキュリティー**タブへ移動します。
9. 以下を設定し、**保存&適用**ボタンをクリックします。
