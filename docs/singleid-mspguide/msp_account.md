...
1. （特権MSPアカウントの管理者）アカウント登録
    ...
    2. **アカウントタイプ**で**MSPアカウント**または**サポートアカウント**を選択し、**顧客情報**および**契約ユーザ数**を入力して、**登録**ボタンをクリックします。

        !!! info
            顧客情報は、MSP/サポートアカウントが作成された後に、**SingleID 管理者ポータル＞管理＞基本情報**画面からお客様自身で変更することもできます。
        
        !!! warning
            MSP/サポートアカウントは、契約ユーザ数に10ユーザより多い値を入力した場合でも、運用上は10ユーザのアカウントとして作成されます。

    3. 登録されたMSP/サポートアカウントは、**SingleID MSP管理者ポータル＞管理アカウント＞承認待ちアカウント一覧**画面に表示されます。申請内容の変更または削除については、[承認待ちアカウント管理](pending_account.md)を参照してください。

2. （SingleID）登録申請されたMSP/サポートアカウントの情報および契約ユーザ数を確認し、**承認**します。
3. （SingleID）システムへMSP/サポートアカウントを**プロビジョニング**します。

    !!! warning
        MSP/サポートアカウントの**承認**および**プロビジョニング**には、**原則3営業日**いただいております。余裕をもって申請いただくことをお勧めします。**至急、対応が必要な場合には、別途、担当営業までご相談ください。**

4. （特権MSPアカウントの管理者）プロビジョニング後、**MSP/サポートアカウント**に、**管理者**を登録します。

    1. 画面上部の**顧客画面**ボタンをクリックし、SingleID 管理者ポータルへ切り替えます。
    2. 左サイドメニューの上部にある**顧客切り替え**から、登録した**MSP/サポートアカウント名を選択**し、対象アカウントの**SingleID 管理者ポータル**へアクセスします。
    3. **SingleID 管理者ポータル＞管理＞管理者**画面へ移動します。
    4. **登録**ボタンをクリックし、MSP/サポートアカウントに**管理者を登録**します。
