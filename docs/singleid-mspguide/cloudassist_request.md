...
顧客用のSingleID 管理者ポータルから顧客アカウントの管理画面に**再認証なしで切り替えアクセス**でき、より迅速で効率的なマネージドサービスの提供を実現します。
...
## クラウドアシストの申請手順
1. **MSP用のSingleID 管理者ポータル＞アカウント管理＞MSPアカウント一覧**画面へ移動します。
...
### 顧客アカウントとの紐づけ設定
1. **MSP用のSingleID 管理者ポータル＞アカウント管理＞顧客アカウント一覧**に移動します。
...
登録が完了すると、販売店の管理者は顧客用のSingleID 管理者ポータルにログインし、画面上部の**顧客切り替え**から、紐づけられた顧客アカウントの設定画面にアクセスできます。
