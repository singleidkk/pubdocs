...
* ユーザ数制限：PoC環境のライセンスは、原則10ユーザ以下とさせていただきます。
* 必要情報：
...
1. PoC環境の**MSP用のSingleID 管理者ポータル＞管理アカウント＞顧客アカウント一覧**へ移動します。
...
4. PoC環境の**SingleID 管理者ポータル＞管理＞管理者**へ移動します。
5. 登録ボタンをクリックし、PoCを実施する会社の担当者を管理者として登録します。**パスワード設定**を**設定URLメール送信**を選択することをお勧めします。

    !!! info
        管理者を登録すると、登録したメールアドレス宛に管理者登録通知が送信されます。**パスワード設定**で**設定URLメール送信**を選択した場合は、パスワード設定の案内も送信されます。
