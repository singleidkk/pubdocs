...
2. **報告したチケット**セクションで、チケットの一覧を確認します。終了したチケットは表示されません。

    進捗状況は、**ステータス**列に表示されます。各ステータスの意味は、[チケットのステータス](status.md)を参照してください。
...
3. チケットの一覧を確認します。終了したチケットは表示されません。
    [![Screenshot](/images/clipboard-202203040740-enzps.png)](/images/clipboard-202203040740-enzps.png)

4. 終了したチケットを含めて表示する場合は、**フィルタ＞ステータス**で**すべて**を選択し、**適用**ボタンをクリックします。
